...
import { potreePath } from '../../../AutoGenerated'
    ...
    async load(node) {
        ...
        try {
            ...
            if (this.metadata.encoding === 'BROTLI') {
                workerPath = potreePath + '/workers/2.0/DecoderWorker_brotli.js'
            } else {
                workerPath = potreePath + '/workers/2.0/DecoderWorker.js'
            }
...
export class OctreeLoader {
    static parseAttributes(jsonAttributes) {
        ...
        for (const jsonAttribute of jsonAttributes) {
            ...
            let potreeAttributeName = replacements[name]
                ? replacements[name]
                : name
...

        {
            ...
            let hasNormals =
                attributes.attributes.find((a) => a.name === 'NormalX') !==
                    undefined &&
                attributes.attributes.find((a) => a.name === 'NormalY') !==
                    undefined &&
                attributes.attributes.find((a) => a.name === 'NormalZ') !==
                    undefined
    ...
    static async load(url) {
        ...
        octree.pointAttributes = OctreeLoader.parseAttributes(
            metadata.attributes,
        )
