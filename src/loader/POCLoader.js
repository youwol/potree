...
function parseAttributes(cloudjs) {
...

    {
...

        {
            ...
            let hasNormals =
                pointAttributes.find((a) => a.name === 'NormalX') !==
                    undefined &&
                pointAttributes.find((a) => a.name === 'NormalY') !==
                    undefined &&
        ...
        try {
            ...
            xhr.onreadystatechange = function () {
                if (
                    ...
                    pco.tightBoundingSphere =
                        tightBoundingBox.getBoundingSphere(new THREE.Sphere())
                    pco.offset = offset
...

                    {
                        ...
                        let root = new PointCloudOctreeGeometryNode(
                            name,
                            pco,
                            boundingBox,
                        )
