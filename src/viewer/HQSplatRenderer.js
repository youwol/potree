    ...
    render(params) {
...

        {
            ...
            for (let pointcloud of visiblePointClouds) {
                ...
                attributeMaterial.activeAttributeName =
                    material.activeAttributeName
                attributeMaterial.visibleNodesTexture =
                    material.visibleNodesTexture
                ...
                attributeMaterial.intensityBrightness =
                ...
                attributeMaterial.weightReturnNumber =
                    material.weightReturnNumber
...

        {
            ...
            if (this.useEDL) {
                normalizationMaterial.uniforms.edlStrength.value =
                    viewer.edlStrength
                ...
                normalizationMaterial.uniforms.uEDLMap.value =
                    this.rtDepth.texture
            }
