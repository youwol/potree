        ...
        for (let handleName of Object.keys(this.focusHandles)) {
            ...
            pickSphere.addEventListener('click', (e) => {
                ...
                let alignment = new THREE.Vector3(
                    ...handle.alignment,
                ).multiplyScalar((2 * maxScale) / handleLength)
    ...
    dragScaleHandle(e) {
...

        {
            ...
            if (I) {
                ...
                let toObjectSpace = this.selection[0].matrixWorld
                    .clone()
                    .invert()
                ...
                let diffScale = new THREE.Vector3(
                    ...handle.alignment,
                ).multiplyScalar(diff.length() * direction * dragDirection)
