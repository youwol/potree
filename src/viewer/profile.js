...
import { resourcePath } from '../AutoGenerated'
    ...
    createNewBatch(data) {
        ...
        for (let attributeName of Object.keys(data.data)) {
            ...
            if (this.trueOctree.root.sceneNode) {
                if (
                    this.trueOctree.root.sceneNode.geometry.attributes[
                        attributeName
                    ]
                ) {
                    normalized =
    ...
    initListeners() {
        ...
        this.renderArea.mousemove((e) => {
            ...
            if (this.mouseIsDown) {
                ...
                // FIND HOVERED POINT
                let radius = Math.abs(
                    this.scaleX.invert(0) - this.scaleX.invert(40),
                )
                ...
                if (closest) {
                    ...
                    for (let attributeName of Object.keys(point)) {
                        ...
                        let attribute =
                            closest.pointcloud.getAttribute(attributeName)
                ...
                for (let pointSet of entry.points) {
                    ...
                    for (let i = 0; i < pointSet.numPoints; i++) {
                        if (truePosition === true) {
                            truePointPosition[3 * i + 0] +=
                                pointcloud.position.x
                            truePointPosition[3 * i + 1] +=
            ...
            for (let points of entry.points) {
                ...
                for (let i = 0; i < points.numPoints; i++) {
                    ...
                    if (points.data.classification) {
                        ...
                        if (
                            pointClassValue &&
                            (!pointClassValue.visible ||
                                pointClassValue.color.w === 0)
                        ) {
    ...
    constructor(viewer) {
        ...
        $('#potree_profile_rotate_amount').on('input', (e) => {
            ...
            if (!isNaN(str)) {
                ...
                $('#potree_profile_rotate_amount').css(
                    'background-color',
                    '#ff9999',
                )
            }
