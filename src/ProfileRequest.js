...
export class ProfileRequest {
        ...
        while (stack.length > 0) {
            ...
            if (node.level < this.maxDepth) {
                for (let i = 0; i < 8; i++) {
                    ...
                    if (
                        child &&
                        this.pointcloud.nodeIntersectsProfile(
                            child,
                            this.profile,
                        )
                    ) {
    ...
    *getAccepted(
        ...
        for (let i = 0; i < numPoints; i++) {
            ...
            let centerDistance = Math.abs(
                segment.halfPlane.distanceToPoint(pos),
            )
        ...
        for (let segment of target.segments) {
            for (let node of nodes) {
...

                {
                    ...
                    let intersects =
                        distance < bsWorld.radius + target.profile.width
                ...
                let relevantAttributes = Object.keys(
                    geometry.attributes,
